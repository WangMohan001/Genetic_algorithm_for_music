@echo off
set CONFIG_PATH="genetic/configs/config_algorithm.json"
set SOUND_FONT="genetic/soundfronts/27.3mg_symphony_hall_bank.SF2"
set OUTPUT_MIDI="output/result.midi"
set OUTPUT_AUDIO="output/result.wav"
set INSTRUMENT="harp"
set INSTRUMENT_JSON_PATH="genetic/configs/instruments.json"
